...
You do not hold hypotheses here. A causal belief requires you to have observed both the leading signal and the lagging outcome at least once. Until that first pairing is visible, the candidate lives in Factual Understanding as a tracked signal.
...
**Is there a new pairing visible for the first time?** Only seed a new causal belief if both the leading signal and a prior lagging outcome are visible — meaning the document reveals a historical instance of the pair, not just a current signal with no outcome yet.
...
- The relationship has held only once — hold as a candidate in Factual Understanding
- The relationship is sector-wide, not specific to this business

## Guardrails

**One observation is not a causal belief.** A single pairing of signal and outcome seeds a candidate in Factual Understanding. The belief requires at least one more confirming instance before it is written here.
...
**Example 2 — New belief seeded from first confirmed pairing**

The Q3 actuals show churn rose to 4.2% from 3.1%. The CFO explicitly linked it to "customers who experienced friction earlier in the year" — the Q2 onboarding drop. The first pairing is now visible: Q2 onboarding decline → Q3 churn increase, approximately one quarter lag. Management attribution corroborates the direction.
...
I filed the Q2 onboarding drop as a candidate signal in Factual Understanding. The Q3 actuals show the expected outcome — churn rose, and the CFO explicitly linked it to the Q2 friction. First confirmed pairing. I'm seeding at low confidence — one observation is not enough to act on predictively. I'd raise confidence if the same sequence appears again. I'd retire this if onboarding declines again and churn does not follow.
```
